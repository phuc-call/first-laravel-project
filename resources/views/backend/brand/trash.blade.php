    ...
    <div class="basis-4/5 bg-white ml-3 rounded-sm h-full">
        <div class="menufd">
            <div class="menu flex justify-between">
                <div class="title m-4 text-blue-500 font-[500] text-2xl">QUAN LY THUONG HIEU</div>
                <div class="update-delete flex">
                    <a class="bg-green-500 rounded-xl mr-2 scale-75" href="{{ route('brand.create') }}">
                        <div>
                            <div class="updata m-4 font-[500] text-2xl text-white"><i class="fas fa-plus-square"></i>
                                Thêm</div>
                        </div>
                    </a>
                    <a class="bg-green-500 rounded-xl mr-2 scale-75" href="{{ route('brand.index') }}">
                        <div>
                            <div class="delete m-4 font-[500] text-2xl text-white">Quay về
                                danh mục</div>
                        </div>
                    </a>
                </div>
                            ...
                            <td class="border border-gray-500 px-4 py-2">
                                @if (!empty($item->image))
                                    <img class="w-32 h-32 object-cover"
                                        src="{{ asset('assets/images/brand/' . $item->image) }}" alt="">
                                @endif
                            </td>
