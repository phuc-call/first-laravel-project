<x-layout--admin>
    <form action="{{ route('order.store') }}" method="post" enctype="multipart/form-data" class="p-4 bg-white shadow-md rounded-lg">
        @csrf
            ...
            <div class="border border-blue-100 rounded-lg p-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                ...
                <div class="col-span-2 space-y-3">
                    ...
                    <div>
                        ...
                        <div class="text-red-500">{{$errors->first('user_id')}}</div>
                        @endif
                    </div>
