        ...
        <div class="menufd">
            <div class="menu flex justify-between">
                ...
                <div class="update-delete flex">
                    <a class="bg-green-500 rounded-xl mr-2 scale-75" href="{{ route('category.index') }}">
                        <div>
                            <div class="updata m-4 font-[500] text-2xl text-white"> về
                                danh mục
                            </div>
                        </div>
                    </a>
                    <a class="bg-green-500 rounded-xl mr-2 scale-75" href="{{ route('category.create') }}">
                        <div>
                            <div class="delete m-4 font-[500] text-2xl text-white"><i class="fas fa-create"></i>Thêm
                            </div>
                        </div>
                    </a>
                </div>
